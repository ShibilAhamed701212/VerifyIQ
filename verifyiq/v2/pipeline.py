...
class V2Pipeline:
    ...
    def __init__(self, config: Optional[dict] = None):
        ...
        if "local" in provider_configs:
            from verifyiq.v2.providers import LocalVLMProvider
